...
def analyze_ci_data():
    """Analyze the Chief Investigator data from 2010-2026"""
...
def create_visualization():
    ...
    years = [year for year in range(2010, 2027) if yearly_project_counts[year] > 0]
    ...
    ax1.set_title('Average Number of Chief Investigators per Discovery Project (2010-2026)', 
    ...
    ax2.set_title('Number of Discovery Projects per Year (2010-2026)', 
                  fontsize=14, fontweight='bold', pad=20)
    ...
    key_years = [2010, 2012, 2015, 2018, 2021, 2024, 2025, 2026]
    ...
    if available_years:
        ...
        fig.suptitle('Distribution of Chief Investigators per Project by Key Years (2010-2026)', 
